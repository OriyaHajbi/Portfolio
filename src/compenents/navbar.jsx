            ...
            <div class=" navbritems" >
                <ul class="navbar-nav text-right">
                    {/* <li class="nav-item active">
                        <FormControlLabel
                            control={<MaterialUISwitch onChange={() => { setMode(!isNightMode); }} sx={{ m: 1 }} defaultChecked checked={isNightMode} />}
                            label="Mode"
                    ...
                    <li class="nav-item active">
                        <a className={`navbarItem ${props.modeClass}navbar`} href="#aboutme">About me</a>
                    </li>
                    <li class="nav-item active">
                    ...
                    <li class="nav-item active">
                        <DayNightToggle
                            onChange={() => props.modeFunc(!props.modeBool)}
                            checked={props.modeBool}
                        />
                    </li>
                </ul>
            </div>
